...
export default function PsychiatricServicesDetails() {
  ...
  const fetchPageContent = async () => {
    try {
      const response = await fetch(`${url_prefix}/api/admin/content?page=psychiatric_services`);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {isAuthenticated && (
        <div className="bg-teal-600 text-white text-center py-2 text-sm font-bold sticky top-0 z-[60] shadow-md flex items-center justify-center gap-2">
          <Edit2 size={16} />
